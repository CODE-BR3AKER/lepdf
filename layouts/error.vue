<template>
  ...
  >
    ...
    <img src="/404.svg" alt="" class="block w-auto md:w-1/3 my-10" />

    <nuxt-link
      to="/"
      class="block mt-4 text-xl px-4 py-2 bg-main text-white border border-main hover:bg-transparent hover:text-main"
    >
